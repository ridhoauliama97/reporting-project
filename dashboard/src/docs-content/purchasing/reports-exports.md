...
## Deskripsi
Halaman agregasi untuk **akses & export semua 14 laporan** dalam satu tempat, digerakkan oleh **1 Date Filter yang sama** untuk semua kartu laporan.
...
- Laporan yang tidak punya data pada rentang filter aktif → tombol Export **disabled**, ditandai **"No Data Available"** — relevan terutama untuk submenu placeholder (#4, #11, #12, #13)
